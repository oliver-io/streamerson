...
test('a consumer group should get new messages published after connection', async () => {
    ...
    // TODO: does this need to be longer than the amount of time it takes to run the mock?
    await waitFor(500);
